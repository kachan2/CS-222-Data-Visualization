...
.e-fab.e-btn:hover, .e-fab.e-btn:focus, .e-fab.e-btn:active, .e-fab.e-btn.e-active, .e-fab.e-btn:disabled {
  box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.2), 0 -2px 15px -3px rgba(0, 0, 0, 0.1), 0 6px 10px rgba(0, 0, 0, 0.14);
}
...
.e-speeddial-popup .e-speeddial-li:focus:not(.e-disabled) .e-speeddial-li-text {
  background-color: #252423;
  border-color: #8a8886;
  box-shadow: #252423 0 6.4px 14.4px 0 rgba(0, 0, 0, 0.132), 0 1.2px 3.6px 0 rgba(0, 0, 0, 0.108);
}
